...
# Import components
from modules.narrative_matrix import NarrativeMatrix
from modules.objectives_manager import ObjectivesManager
from modules.llm_research_strategy import LLMResearchStrategy
from modules.crawler import Crawler
try:
    from modules.llm_engine import LLMIntegration  # Assume this is the correct module
except ImportError:
    # Fallback - create a stub class for LLMIntegration
    class LLMIntegration:
        def __init__(self, use_claude=True, use_openai=False):
            self.use_claude = use_claude
            self.use_openai = use_openai
            logger.warning("Using stub LLMIntegration class")
            
        def run_prompt(self, prompt, max_tokens=1000):
            return "This is a stub LLM response for testing purposes."
            
        def generate_research_strategy(self, prompt, entity):
            return {"crawlable_urls": [], "search_queries": []}

from modules.name_artifact_extractor import NameArtifactExtractor
